...
var Event = {
  ...
  /**
   * Stores the list of subscribers for events.
   * @attribute Event.subscribers
   * @type JSON
   * @private
   * @required
   * @for Skylink
  ...
  subscribers: {
    /**
     * Stores subscribers that would be fired often.
     * @property subscribers.on
     * @type JSON
     * @private
     * @required
     * @for Skylink
    ...
    on: events,
    /**
     * Stores subscribers that would be fired only once once condition is met.
     * @property subscribers.once
     * @type JSON
     * @private
     * @required
     * @for Skylink
   ...
   * @since 0.5.4
   */
  once: function(eventName, callback, condition, fireAlways) {
   ...
   * @since 0.5.5
   */
  condition: function(eventName, callback, checkFirst, condition, fireAlways) {
    if (typeof condition === 'boolean') {
      fireAlways = condition;
      condition = null;
    }
   ...
   * @since 0.5.5
   */
  wait: function(callback, condition, intervalTime, fireAlways) {
    fireAlways = (typeof fireAlways === 'undefined' ? false : fireAlways);
